"""Tests for fare data loading, decimal conversion, and formatting."""
...
def test_as_decimal_converts_supported_values() -> None:
    """Verify that as decimal converts supported values."""
...
def test_load_fare_data_builds_expected_objects(tmp_path) -> None:
    """Verify that load fare data builds expected objects."""
...
def test_format_money_uses_pounds_and_two_decimal_places() -> None:
    """Verify that format money uses pounds and two decimal places."""
